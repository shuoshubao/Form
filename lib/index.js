...
import { Card, Button, DatePicker, Radio, InputNumber, Tooltip, message } from 'antd';
...
class Index extends Component {
    ...
    getFormItemNode = v => {
        const { name, label, rules, template } = v;
        const { tpl } = template;
    ...
    renderColumns = () => {
        ...
        const columnsNode = columns
            ...
            .map((v, i) => {
                const { name, label, rules, formListProps, template } = v;
                ...
                if (formListProps) {
                    ...
                    return (
                        <Form.List name={name} key={formItemProps.key}>
                                        ...
                                        {fields.map((field, index) => {
                                            return (
                                                ...
                                                >
                                                    <Form.Item
                                                        {...field}
                                                        {...omit(formItemProps, ['name', 'label', 'style'])}
