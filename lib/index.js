...
import { cloneDeep, debounce, isFunction, omit, merge, isEqual } from 'lodash';
...
class Index extends Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        const nextColumns = mergeColumns(nextProps.columns, { disabled: nextProps.disabled });
        if (!isEmptyArray(prevState.columns) && !isEqual(nextColumns, prevState.columns)) {
            return {
                columns: nextColumns
            };
        }
