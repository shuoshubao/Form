...
import { omit, pick, isObject, cloneDeep, noop, debounce, isEqual, map } from 'lodash';
...
class Index extends Component {
    ...
    render() {
        const { props, state } = this;
        const { value, onChange, allItem, showSearch, mode } = props;
            ...
            componentProps.dropdownRender = menu => {
                return (
                    <>
                        ...
                        <div className="ant-select-dropdown-menu-item">
