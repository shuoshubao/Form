...
import { omit, inRange, kebabCase, find, get, flatten, isString, isObject, merge, filter } from 'lodash';
  ...
  return function (text, record, index) {
    ...
    if (tpl === 'image') {
      ...
      if (value) {
        ...
        var Image$1 = get(window, 'antd.Image');

        if (Image$1) {
          return /*#__PURE__*/React.createElement(Image$1, ImageProps);
        }
